...
pub const DN_ACCESS: c_int = 1;
pub const DN_MODIFY: c_int = 2;
pub const DN_CREATE: c_int = 4;
pub const DN_DELETE: c_int = 8;
pub const DN_RENAME: c_int = 16;
pub const DN_ATTRIB: c_int = 32;
...
pub const RISCV_HWPROBE_BASE_BEHAVIOR_IMA: c_int = 1 << 0;
pub const RISCV_HWPROBE_KEY_IMA_EXT_0: c_int = 4;
pub const RISCV_HWPROBE_IMA_FD: c_int = 1 << 0;
pub const RISCV_HWPROBE_IMA_C: c_int = 1 << 1;
pub const RISCV_HWPROBE_IMA_V: c_int = 1 << 2;
pub const RISCV_HWPROBE_EXT_ZBA: c_int = 1 << 3;
pub const RISCV_HWPROBE_EXT_ZBB: c_int = 1 << 4;
pub const RISCV_HWPROBE_EXT_ZBS: c_int = 1 << 5;
pub const RISCV_HWPROBE_EXT_ZICBOZ: c_int = 1 << 6;
pub const RISCV_HWPROBE_EXT_ZBC: c_int = 1 << 7;
pub const RISCV_HWPROBE_EXT_ZBKB: c_int = 1 << 8;
pub const RISCV_HWPROBE_EXT_ZBKC: c_int = 1 << 9;
pub const RISCV_HWPROBE_EXT_ZBKX: c_int = 1 << 10;
pub const RISCV_HWPROBE_EXT_ZKND: c_int = 1 << 11;
pub const RISCV_HWPROBE_EXT_ZKNE: c_int = 1 << 12;
pub const RISCV_HWPROBE_EXT_ZKNH: c_int = 1 << 13;
pub const RISCV_HWPROBE_EXT_ZKSED: c_int = 1 << 14;
pub const RISCV_HWPROBE_EXT_ZKSH: c_int = 1 << 15;
pub const RISCV_HWPROBE_EXT_ZKT: c_int = 1 << 16;
pub const RISCV_HWPROBE_EXT_ZVBB: c_int = 1 << 17;
pub const RISCV_HWPROBE_EXT_ZVBC: c_int = 1 << 18;
pub const RISCV_HWPROBE_EXT_ZVKB: c_int = 1 << 19;
pub const RISCV_HWPROBE_EXT_ZVKG: c_int = 1 << 20;
pub const RISCV_HWPROBE_EXT_ZVKNED: c_int = 1 << 21;
pub const RISCV_HWPROBE_EXT_ZVKNHA: c_int = 1 << 22;
pub const RISCV_HWPROBE_EXT_ZVKNHB: c_int = 1 << 23;
pub const RISCV_HWPROBE_EXT_ZVKSED: c_int = 1 << 24;
pub const RISCV_HWPROBE_EXT_ZVKSH: c_int = 1 << 25;
pub const RISCV_HWPROBE_EXT_ZVKT: c_int = 1 << 26;
pub const RISCV_HWPROBE_EXT_ZFH: c_int = 1 << 27;
pub const RISCV_HWPROBE_EXT_ZFHMIN: c_int = 1 << 28;
pub const RISCV_HWPROBE_EXT_ZIHINTNTL: c_int = 1 << 29;
pub const RISCV_HWPROBE_EXT_ZVFH: c_int = 1 << 30;
pub const RISCV_HWPROBE_EXT_ZVFHMIN: c_uint = 1 << 31;
pub const RISCV_HWPROBE_EXT_ZFA: c_uint = 1 << 32;
pub const RISCV_HWPROBE_EXT_ZTSO: c_uint = 1 << 33;
pub const RISCV_HWPROBE_EXT_ZACAS: c_uint = 1 << 34;
pub const RISCV_HWPROBE_EXT_ZICOND: c_uint = 1 << 35;
pub const RISCV_HWPROBE_EXT_ZIHINTPAUSE: c_uint = 1 << 36;
pub const RISCV_HWPROBE_EXT_ZVE32X: c_uint = 1 << 37;
pub const RISCV_HWPROBE_EXT_ZVE32F: c_uint = 1 << 38;
pub const RISCV_HWPROBE_EXT_ZVE64X: c_uint = 1 << 39;
pub const RISCV_HWPROBE_EXT_ZVE64F: c_uint = 1 << 40;
pub const RISCV_HWPROBE_EXT_ZVE64D: c_uint = 1 << 41;
pub const RISCV_HWPROBE_EXT_ZIMOP: c_uint = 1 << 42;
pub const RISCV_HWPROBE_EXT_ZCA: c_uint = 1 << 43;
pub const RISCV_HWPROBE_EXT_ZCB: c_uint = 1 << 44;
pub const RISCV_HWPROBE_EXT_ZCD: c_uint = 1 << 45;
pub const RISCV_HWPROBE_EXT_ZCF: c_uint = 1 << 46;
pub const RISCV_HWPROBE_EXT_ZCMOP: c_uint = 1 << 47;
pub const RISCV_HWPROBE_EXT_ZAWRS: c_uint = 1 << 48;
pub const RISCV_HWPROBE_EXT_SUPM: c_uint = 1 << 49;
pub const RISCV_HWPROBE_EXT_ZICNTR: c_uint = 1 << 50;
pub const RISCV_HWPROBE_EXT_ZIHPM: c_uint = 1 << 51;
pub const RISCV_HWPROBE_EXT_ZFBFMIN: c_uint = 1 << 52;
pub const RISCV_HWPROBE_EXT_ZVFBFMIN: c_uint = 1 << 53;
pub const RISCV_HWPROBE_EXT_ZVFBFWMA: c_uint = 1 << 54;
pub const RISCV_HWPROBE_EXT_ZICBOM: c_uint = 1 << 55;
pub const RISCV_HWPROBE_EXT_ZAAMO: c_uint = 1 << 56;
pub const RISCV_HWPROBE_EXT_ZALRSC: c_uint = 1 << 57;
pub const RISCV_HWPROBE_EXT_ZABHA: c_uint = 1 << 58;
pub const RISCV_HWPROBE_KEY_CPUPERF_0: c_int = 5;
pub const RISCV_HWPROBE_MISALIGNED_UNKNOWN: c_int = 0 << 0;
pub const RISCV_HWPROBE_MISALIGNED_EMULATED: c_int = 1 << 0;
pub const RISCV_HWPROBE_MISALIGNED_SLOW: c_int = 2 << 0;
pub const RISCV_HWPROBE_MISALIGNED_FAST: c_int = 3 << 0;
pub const RISCV_HWPROBE_MISALIGNED_UNSUPPORTED: c_int = 4 << 0;
pub const RISCV_HWPROBE_MISALIGNED_MASK: c_int = 7 << 0;
...
// abi-bits/shm.h
pub const _POSIX_VERSION: c_long = 202405;
pub const _XOPEN_VERSION: c_int = 800;
pub const _POSIX_ADVISORY_INFO: c_int = _POSIX_VERSION;
pub const _POSIX_ASYNCHRONOUS_IO: c_int = _POSIX_VERSION;
pub const _POSIX_BARRIERS: c_int = _POSIX_VERSION;
pub const _POSIX_CHOWN_RESTRICTED: c_int = _POSIX_VERSION;
pub const _POSIX_CLOCK_SELECTION: c_int = _POSIX_VERSION;
pub const _POSIX_JOB_CONTROL: c_int = 1;
pub const _POSIX_MEMORY_PROTECTION: c_int = _POSIX_VERSION;
pub const _POSIX_MONOTONIC_CLOCK: c_int = 0;
pub const _POSIX_NO_TRUNC: c_int = _POSIX_VERSION;
pub const _POSIX_READER_WRITER_LOCKS: c_int = _POSIX_VERSION;
pub const _POSIX_REALTIME_SIGNALS: c_int = _POSIX_VERSION;
pub const _POSIX_REGEXP: c_int = _POSIX_VERSION;
pub const _POSIX_SAVED_IDS: c_int = 1;
pub const _POSIX_SEMAPHORES: c_int = _POSIX_VERSION;
pub const _POSIX_SHELL: c_int = 1;
pub const _POSIX_TIMEOUTS: c_int = _POSIX_VERSION;
pub const _POSIX_TIMERS: c_int = _POSIX_VERSION;
pub const _POSIX_MAPPED_FILES: c_int = _POSIX_VERSION;
pub const _POSIX_MEMLOCK: c_int = _POSIX_VERSION;
pub const _POSIX_MEMLOCK_RANGE: c_int = _POSIX_VERSION;
pub const _POSIX_SHARED_MEMORY_OBJECTS: c_int = _POSIX_VERSION;
pub const _POSIX_SYNCHRONIZED_IO: c_int = _POSIX_VERSION;
...
s! {
    pub struct __ucontext {
        ...
        pub __fpregs_mem: crate::_fpstate,
        pub __ssp: [c_ulong; 4],
    }
}
...
// arpa/telnet.h
pub const IAC: c_int = 255;
pub const DONT: c_int = 254;
pub const DO: c_int = 253;
pub const WONT: c_int = 252;
pub const WILL: c_int = 251;
pub const SB: c_int = 250;
pub const GA: c_int = 249;
pub const EL: c_int = 248;
pub const EC: c_int = 247;
pub const AYT: c_int = 246;
pub const AO: c_int = 245;
pub const IP: c_int = 244;
pub const BREAK: c_int = 243;
pub const DM: c_int = 242;
pub const NOP: c_int = 241;
pub const SE: c_int = 240;
pub const EOR: c_int = 239;
pub const ABORT: c_int = 238;
pub const SUSP: c_int = 237;
pub const xEOF: c_int = 236;
...
s! {
    pub struct fenv_t {
        pub __control_word: u32,
        pub __status_word: u32,
        pub __unused: [u32; 5],
        pub __mxcsr: u32,
    }
}
...
// bits/nl_item.h
pub const CODESET: c_int = CODESET;
pub const DECIMAL_POINT: c_int = __DECIMAL_POINT;
pub const RADIXCHAR: c_int = RADIXCHAR;
pub const THOUSANDS_SEP: c_int = __THOUSANDS_SEP;
pub const THOUSEP: c_int = THOUSEP;
pub const GROUPING: c_int = __GROUPING;
pub const ABDAY_1: c_int = ABDAY_1;
pub const ABDAY_2: c_int = ABDAY_2;
pub const ABDAY_3: c_int = ABDAY_3;
pub const ABDAY_4: c_int = ABDAY_4;
pub const ABDAY_5: c_int = ABDAY_5;
pub const ABDAY_6: c_int = ABDAY_6;
pub const ABDAY_7: c_int = ABDAY_7;
pub const DAY_1: c_int = DAY_1;
pub const DAY_2: c_int = DAY_2;
pub const DAY_3: c_int = DAY_3;
pub const DAY_4: c_int = DAY_4;
pub const DAY_5: c_int = DAY_5;
pub const DAY_6: c_int = DAY_6;
pub const DAY_7: c_int = DAY_7;
pub const ABMON_1: c_int = ABMON_1;
pub const ABMON_2: c_int = ABMON_2;
pub const ABMON_3: c_int = ABMON_3;
pub const ABMON_4: c_int = ABMON_4;
pub const ABMON_5: c_int = ABMON_5;
pub const ABMON_6: c_int = ABMON_6;
pub const ABMON_7: c_int = ABMON_7;
pub const ABMON_8: c_int = ABMON_8;
pub const ABMON_9: c_int = ABMON_9;
pub const ABMON_10: c_int = ABMON_10;
pub const ABMON_11: c_int = ABMON_11;
pub const ABMON_12: c_int = ABMON_12;
pub const MON_1: c_int = MON_1;
pub const MON_2: c_int = MON_2;
pub const MON_3: c_int = MON_3;
pub const MON_4: c_int = MON_4;
pub const MON_5: c_int = MON_5;
pub const MON_6: c_int = MON_6;
pub const MON_7: c_int = MON_7;
pub const MON_8: c_int = MON_8;
pub const MON_9: c_int = MON_9;
pub const MON_10: c_int = MON_10;
pub const MON_11: c_int = MON_11;
pub const MON_12: c_int = MON_12;
pub const AM_STR: c_int = AM_STR;
pub const PM_STR: c_int = PM_STR;
pub const D_T_FMT: c_int = D_T_FMT;
pub const D_FMT: c_int = D_FMT;
pub const T_FMT: c_int = T_FMT;
pub const T_FMT_AMPM: c_int = T_FMT_AMPM;
pub const ERA: c_int = ERA;
pub const ERA_YEAR: c_int = __ERA_YEAR;
pub const ERA_D_FMT: c_int = ERA_D_FMT;
pub const ALT_DIGITS: c_int = ALT_DIGITS;
pub const ERA_D_T_FMT: c_int = ERA_D_T_FMT;
pub const ERA_T_FMT: c_int = ERA_T_FMT;
pub const _DATE_FMT: c_int = _DATE_FMT;
pub const ALTMON_1: c_int = __ALTMON_1;
pub const ALTMON_2: c_int = __ALTMON_2;
pub const ALTMON_3: c_int = __ALTMON_3;
pub const ALTMON_4: c_int = __ALTMON_4;
pub const ALTMON_5: c_int = __ALTMON_5;
pub const ALTMON_6: c_int = __ALTMON_6;
pub const ALTMON_7: c_int = __ALTMON_7;
pub const ALTMON_8: c_int = __ALTMON_8;
pub const ALTMON_9: c_int = __ALTMON_9;
pub const ALTMON_10: c_int = __ALTMON_10;
pub const ALTMON_11: c_int = __ALTMON_11;
pub const ALTMON_12: c_int = __ALTMON_12;
pub const ABALTMON_1: c_int = _NL_ABALTMON_1;
pub const ABALTMON_2: c_int = _NL_ABALTMON_2;
pub const ABALTMON_3: c_int = _NL_ABALTMON_3;
pub const ABALTMON_4: c_int = _NL_ABALTMON_4;
pub const ABALTMON_5: c_int = _NL_ABALTMON_5;
pub const ABALTMON_6: c_int = _NL_ABALTMON_6;
pub const ABALTMON_7: c_int = _NL_ABALTMON_7;
pub const ABALTMON_8: c_int = _NL_ABALTMON_8;
pub const ABALTMON_9: c_int = _NL_ABALTMON_9;
pub const ABALTMON_10: c_int = _NL_ABALTMON_10;
pub const ABALTMON_11: c_int = _NL_ABALTMON_11;
pub const ABALTMON_12: c_int = _NL_ABALTMON_12;
pub const INT_CURR_SYMBOL: c_int = __INT_CURR_SYMBOL;
pub const CURRENCY_SYMBOL: c_int = __CURRENCY_SYMBOL;
pub const MON_DECIMAL_POINT: c_int = __MON_DECIMAL_POINT;
pub const MON_THOUSANDS_SEP: c_int = __MON_THOUSANDS_SEP;
pub const MON_GROUPING: c_int = __MON_GROUPING;
pub const POSITIVE_SIGN: c_int = __POSITIVE_SIGN;
pub const NEGATIVE_SIGN: c_int = __NEGATIVE_SIGN;
pub const INT_FRAC_DIGITS: c_int = __INT_FRAC_DIGITS;
pub const FRAC_DIGITS: c_int = __FRAC_DIGITS;
pub const P_CS_PRECEDES: c_int = __P_CS_PRECEDES;
pub const P_SEP_BY_SPACE: c_int = __P_SEP_BY_SPACE;
pub const N_CS_PRECEDES: c_int = __N_CS_PRECEDES;
pub const N_SEP_BY_SPACE: c_int = __N_SEP_BY_SPACE;
pub const P_SIGN_POSN: c_int = __P_SIGN_POSN;
pub const N_SIGN_POSN: c_int = __N_SIGN_POSN;
pub const CRNCYSTR: c_int = _NL_MONETARY_CRNCYSTR;
pub const INT_P_CS_PRECEDES: c_int = __INT_P_CS_PRECEDES;
pub const INT_P_SEP_BY_SPACE: c_int = __INT_P_SEP_BY_SPACE;
pub const INT_N_CS_PRECEDES: c_int = __INT_N_CS_PRECEDES;
pub const INT_N_SEP_BY_SPACE: c_int = __INT_N_SEP_BY_SPACE;
pub const INT_P_SIGN_POSN: c_int = __INT_P_SIGN_POSN;
pub const INT_N_SIGN_POSN: c_int = __INT_N_SIGN_POSN;
pub const YESEXPR: c_int = __YESEXPR;
pub const NOEXPR: c_int = __NOEXPR;
pub const YESSTR: c_int = __YESSTR;
pub const NOSTR: c_int = __NOSTR;
...
pub type pthread_key_t = crate::__mlibc_uintptr;
...
// cpio.h
pub const C_IRUSR: c_int = 0o000400;
pub const C_IWUSR: c_int = 0o000200;
pub const C_IXUSR: c_int = 0o000100;
pub const C_IRGRP: c_int = 0o000040;
pub const C_IWGRP: c_int = 0o000020;
pub const C_IXGRP: c_int = 0o000010;
pub const C_IROTH: c_int = 0o000004;
pub const C_IWOTH: c_int = 0o000002;
pub const C_IXOTH: c_int = 0o000001;
pub const C_ISUID: c_int = 0o004000;
pub const C_ISGID: c_int = 0o002000;
pub const C_ISVTX: c_int = 0o001000;
pub const C_ISDIR: c_int = 0o040000;
pub const C_ISFIFO: c_int = 0o010000;
pub const C_ISREG: c_int = 0o100000;
pub const C_ISBLK: c_int = 0o060000;
pub const C_ISCHR: c_int = 0o020000;
pub const C_ISCTG: c_int = 0o110000;
pub const C_ISLNK: c_int = 0o120000;
pub const C_ISSOCK: c_int = 0o140000;
pub const MAGIC: c_int = "070707";
...
pub const WORD_BIT: c_int = 32;
pub const _POSIX_AIO_LISTIO_MAX: c_int = 2;
pub const _POSIX_AIO_MAX: c_int = 1;
pub const _POSIX_ARG_MAX: c_int = 4096;
pub const _POSIX_CHILD_MAX: c_int = 25;
pub const _POSIX_CLOCKRES_MIN: c_int = 20000000;
pub const _POSIX_DELAYTIMER_MAX: c_int = 32;
pub const _POSIX_HOST_NAME_MAX: c_int = 255;
pub const _POSIX_LINK_MAX: c_int = 8;
pub const _POSIX_LOGIN_NAME_MAX: c_int = 9;
pub const _POSIX_MAX_CANON: c_int = 255;
pub const _POSIX_MAX_INPUT: c_int = 255;
pub const _POSIX_MQ_OPEN_MAX: c_int = 8;
pub const _POSIX_MQ_PRIO_MAX: c_int = 32;
pub const _POSIX_NAME_MAX: c_int = 14;
pub const _POSIX_NGROUPS_MAX: c_int = 8;
pub const _POSIX_OPEN_MAX: c_int = 16;
pub const _POSIX_PATH_MAX: c_int = 256;
pub const _POSIX_PIPE_BUF: c_int = 512;
pub const _POSIX_RE_DUP_MAX: c_int = 255;
pub const _POSIX_RTSIG_MAX: c_int = 8;
pub const _POSIX_SEM_NSEMS_MAX: c_int = 256;
pub const _POSIX_SEM_VALUE_MAX: c_int = 32767;
pub const _POSIX_SIGQUEUE_MAX: c_int = 32;
pub const _POSIX_SSIZE_MAX: c_int = SSIZE_MAX;
pub const _POSIX_SS_REPL_MAX: c_int = 4;
pub const _POSIX_STREAM_MAX: c_int = 8;
pub const _POSIX_SYMLINK_MAX: c_int = 255;
pub const _POSIX_SYMLOOP_MAX: c_int = 8;
pub const _POSIX_THREAD_DESTRUCTOR_ITERATIONS: c_int = 4;
pub const _POSIX_THREAD_KEYS_MAX: c_int = 128;
pub const _POSIX_THREAD_THREADS_MAX: c_int = 64;
pub const _POSIX_TIMER_MAX: c_int = 32;
pub const _POSIX_TTY_NAME_MAX: c_int = 9;
...
pub const _XOPEN_PATH_MAX: c_int = 1024;
pub const TZNAME_MAX: c_int = _POSIX_TZNAME_MAX;
pub const NL_ARGMAX: c_int = 9;
pub const NL_LANGMAX: c_int = _POSIX2_LINE_MAX;
pub const PTHREAD_STACK_MIN: usize = 16384;
pub const PTHREAD_KEYS_MAX: c_int = 1024;
pub const IOV_MAX: c_int = __MLIBC_IOV_MAX;
pub const LOGIN_NAME_MAX: c_int = __MLIBC_LOGIN_NAME_MAX;
pub const HOST_NAME_MAX: c_int = __MLIBC_HOST_NAME_MAX;
pub const NAME_MAX: c_int = __MLIBC_NAME_MAX;
pub const OPEN_MAX: c_int = __MLIBC_OPEN_MAX;
...
extern "C" {
    ...
    pub fn mempcpy(__dest: *mut c_void, __src: *const c_void, __size: crate::size_t)
        -> *mut c_void;
    pub fn explicit_bzero(__s: *mut c_void, __len: crate::size_t);
}
...
pub const stderr: c_int = stderr;
pub const stdin: c_int = stdin;
pub const stdout: c_int = stdout;
...
pub type caddr_t = crate::__caddr_t;
...
pub const PTHREAD_SPIN_INITIALIZER: c_int = { 0 };
...
extern "C" {
    ...
    pub fn pthread_rwlock_timedwrlock(
        __mtx: *mut crate::pthread_rwlock_t,
        __abs_timeout: *const crate::timespec,
    ) -> c_int;
    ...
    pub fn pthread_spin_init(__lock: *mut crate::pthread_spinlock_t, __pshared: c_int) -> c_int;
    pub fn pthread_spin_destroy(__lock: *mut crate::pthread_spinlock_t) -> c_int;
    pub fn pthread_spin_lock(__lock: *mut crate::pthread_spinlock_t) -> c_int;
    pub fn pthread_spin_trylock(__lock: *mut crate::pthread_spinlock_t) -> c_int;
    pub fn pthread_spin_unlock(__lock: *mut crate::pthread_spinlock_t) -> c_int;
}
...
// tar.h
pub const TMAGIC: c_int = "ustar";
pub const TMAGLEN: c_int = 6;
pub const TVERSION: c_int = "00";
pub const TVERSLEN: c_int = 2;
pub const REGTYPE: c_int = '0';
pub const AREGTYPE: c_int = '\0';
pub const LNKTYPE: c_int = '1';
pub const SYMTYPE: c_int = '2';
pub const CHRTYPE: c_int = '3';
pub const BLKTYPE: c_int = '4';
pub const DIRTYPE: c_int = '5';
pub const FIFOTYPE: c_int = '6';
pub const CONTTYPE: c_int = '7';
pub const TSUID: c_int = 0o4000;
pub const TSGID: c_int = 0o2000;
pub const TSVTX: c_int = 0o1000;
pub const TUREAD: c_int = 0o0400;
pub const TUWRITE: c_int = 0o0200;
pub const TUEXEC: c_int = 0o0100;
pub const TGREAD: c_int = 0o0040;
pub const TGWRITE: c_int = 0o0020;
pub const TGEXEC: c_int = 0o0010;
pub const TOREAD: c_int = 0o0004;
pub const TOWRITE: c_int = 0o0002;
pub const TOEXEC: c_int = 0o0001;
